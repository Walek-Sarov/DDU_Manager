...
Процедура ПредметПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.Предмет) И (Не ЗначениеЗаполнено(Объект.Наименование) Или Объект.Наименование = "Зарегистрировать ") Тогда 
		Объект.Наименование = "Зарегистрировать """ + Строка(Объект.Предмет) + """";
	КонецЕсли;	
