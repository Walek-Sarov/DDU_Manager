...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = ПолучитьОбщийМакет("ОКПДТР_Профессии");
...
Функция НайтиЭлемент(Наименование)
	 ...
	 Возврат Справочники.удуПрофессииРабочих.НайтиПоНаименованию(Наименование);
	...
	Если ТекущаяОбласть.Низ = ТекущаяОбласть.Верх Тогда
		...
		Если НЕ Ссылка.Пустая() Тогда
			...
			Если      Ответ = КодВозвратаДиалога.Да Тогда
				...
				ФормаЭлемента=ПолучитьФорму("Справочник.удуПрофессииРабочих.Форма.ФормаЭлемента",Новый Структура("Ключ",Ссылка),ВладелецФормы, );
		...
		ФормаНовогоЭлемента = ПолучитьФорму("Справочник.удуПрофессииРабочих.Форма.ФормаЭлемента", ,ВладелецФормы, );
