...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.удуКлассификаторСпециальностейПоОбразованию.ПолучитьМакет("КлассификаторСпециальностейПоОбразованию");
...
Функция НайтиЭлемент(Наименование)
	 ...
	 Возврат Справочники.удуКлассификаторСпециальностейПоОбразованию.НайтиПоНаименованию(Наименование);
	...
	Если ТекущаяОбласть.Низ = ТекущаяОбласть.Верх Тогда
		...
		Если НЕ Ссылка.Пустая() Тогда
			...
			Если      Ответ = КодВозвратаДиалога.Да Тогда
				...
				ФормаЭлемента=ПолучитьФорму("Справочник.удуКлассификаторСпециальностейПоОбразованию.Форма.ФормаЭлемента",Новый Структура("Ключ",Ссылка),ВладелецФормы, );
		...
		ФормаНовогоЭлемента = ПолучитьФорму("Справочник.удуКлассификаторСпециальностейПоОбразованию.Форма.ФормаЭлемента", ,ВладелецФормы, );
