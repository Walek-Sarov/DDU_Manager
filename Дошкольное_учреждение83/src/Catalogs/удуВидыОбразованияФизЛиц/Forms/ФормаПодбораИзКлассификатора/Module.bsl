...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.удуВидыОбразованияФизЛиц.ПолучитьМакет("КлассификаторВидовОбразования");
...
Функция НайтиЭлемент(Наименование)
	 ...
	 Возврат Справочники.удуВидыОбразованияФизЛиц.НайтиПоНаименованию(Наименование);
...
Процедура КлассификаторОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если ТекущаяОбласть.Низ = ТекущаяОбласть.Верх Тогда
		...
		Если НЕ Ссылка.Пустая() Тогда
			...
			Вопрос = "В справочнике ""Виды образования физических лиц"" уже существует элемент с наименованием """ + Наименование + """! Открыть существующий?";
			Ответ  = Вопрос(Вопрос, РежимДиалогаВопрос.ДаНетОтмена, , КодВозвратаДиалога.Отмена, );
			
			Если      Ответ = КодВозвратаДиалога.Да Тогда
				
				ФормаЭлемента=ПолучитьФорму("Справочник.удуВидыОбразованияФизЛиц.Форма.ФормаЭлемента",Новый Структура("Ключ",Ссылка),ВладелецФормы, );
		...
		ФормаНовогоЭлемента = ПолучитьФорму("Справочник.удуВидыОбразованияФизЛиц.Форма.ФормаЭлемента", ,ВладелецФормы, );
