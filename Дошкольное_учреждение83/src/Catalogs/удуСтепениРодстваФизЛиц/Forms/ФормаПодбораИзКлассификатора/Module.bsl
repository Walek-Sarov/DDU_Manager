...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.удуСтепениРодстваФизЛиц.ПолучитьМакет("КлассификаторРодства");
...
Функция НайтиЭлемент(Наименование)
	 ...
	 Возврат Справочники.удуСтепениРодстваФизЛиц.НайтиПоНаименованию(Наименование);
	...
	Если ТекущаяОбласть.Низ = ТекущаяОбласть.Верх Тогда
		...
		Если НЕ Ссылка.Пустая() Тогда
			...
			Если      Ответ = КодВозвратаДиалога.Да Тогда
				...
				ФормаЭлемента=ПолучитьФорму("Справочник.удуСтепениРодстваФизЛиц.Форма.ФормаЭлемента",Новый Структура("Ключ",Ссылка),ВладелецФормы, );
		...
		ФормаНовогоЭлемента = ПолучитьФорму("Справочник.удуСтепениРодстваФизЛиц.Форма.ФормаЭлемента", ,ВладелецФормы, );
