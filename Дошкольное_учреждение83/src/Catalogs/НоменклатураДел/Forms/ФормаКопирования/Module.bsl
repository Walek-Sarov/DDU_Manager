...
Процедура Скопировать(Команда)
	...
	ПоказатьОповещениеПользователя(
			"Копирование:", ,
			"Скопированы выделенные элементы номенклатуры дел",
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьУчетПоОрганизациям") Тогда 
		ПроверяемыеРеквизиты.Удалить(ПроверяемыеРеквизиты.Найти("ИзОрганизации"));
		ПроверяемыеРеквизиты.Удалить(ПроверяемыеРеквизиты.Найти("ВОрганизацию"));
	КонецЕсли;
