...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.удуЯзыкиНародовМира.ПолучитьМакет("КлассификаторЯзыковНародовМира");
...
Функция НайтиЭлемент(Наименование)
	 ...
	 Возврат Справочники.удуЯзыкиНародовМира.НайтиПоНаименованию(Наименование);
...
Процедура КлассификаторОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если ТекущаяОбласть.Низ = ТекущаяОбласть.Верх Тогда
		...
		Если НЕ Ссылка.Пустая() Тогда
			...
			Вопрос = "В справочнике ""Языки народов мира"" уже существует элемент с наименованием """ + Наименование + """! Открыть существующий?";
			Ответ  = Вопрос(Вопрос, РежимДиалогаВопрос.ДаНетОтмена, , КодВозвратаДиалога.Отмена, );
			
			Если      Ответ = КодВозвратаДиалога.Да Тогда
				
				ФормаЭлемента=ПолучитьФорму("Справочник.удуЯзыкиНародовМира.Форма.ФормаЭлемента",Новый Структура("Ключ",Ссылка),ВладелецФормы, );
		...
		ФормаНовогоЭлемента = ПолучитьФорму("Справочник.удуЯзыкиНародовМира.Форма.ФормаЭлемента", ,ВладелецФормы, );
