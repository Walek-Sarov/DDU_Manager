...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого Строка Из ДелаХраненияДокументов Цикл
		...
		Если ИспользоватьУчетПоОрганизациям Тогда
			Если ЗначениеЗаполнено(Строка.ДелоХраненияДокументов) И Строка.ДелоХраненияДокументов.Организация <> Организация Тогда 
		...
		Если ЗначениеЗаполнено(Строка.ДелоХраненияДокументов) И (Не Строка.ДелоХраненияДокументов.ДелоЗакрыто) Тогда 
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		...
		Если ЗначениеЗаполнено(Строка.ДелоХраненияДокументов) И ТипЗнч(СрокХранения) = Тип("Число") Тогда 
			ХранитсяПолныхЛет = Год(Дата) - Год(Строка.ДелоХраненияДокументов.ДатаОкончания) - 1;
