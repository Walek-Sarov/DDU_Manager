...
Процедура РаботникиОрганизацииДатаВозвратаПриИзменении(Элемент)
	...
	ТЧ=Элементы.РаботникиОрганизации.ТекущиеДанные;
	Если ТЧ.ДатаВозврата > ТекущаяДата() Тогда
		ТекстВопроса = "Вы действительно хотите вернуть сотрудника на будущую дату?";
		Ответ = Вопрос(ТекстВопроса, РежимДиалогаВопрос.ДаНет,,КодВозвратаДиалога.Нет);
		Если Ответ = КодВозвратаДиалога.Нет Тогда
			ТЧ.ДатаВозврата = ТекущаяДата();
		КонецЕсли;
	КонецЕсли;
