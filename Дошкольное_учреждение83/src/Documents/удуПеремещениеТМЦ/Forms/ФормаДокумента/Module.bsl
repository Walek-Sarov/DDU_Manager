...
Процедура УправлениеВидимостью()
	...
	Элементы.СкладПриемник.Видимость    = Не Объект.СкладыВТабличнойЧасти;
	Элементы.ТМЦСклад.Видимость = Объект.СкладыВТабличнойЧасти;
	Элементы.ТМЦСкладПриемник.Видимость = Объект.СкладыВТабличнойЧасти;
	Элементы.УчетныеЕдиницыСклад.Видимость = Объект.СкладыВТабличнойЧасти;
	Элементы.УчетныеЕдиницыСкладПриемник.Видимость = Объект.СкладыВТабличнойЧасти;
