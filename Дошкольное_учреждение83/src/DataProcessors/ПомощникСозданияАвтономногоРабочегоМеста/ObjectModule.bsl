...
Процедура СоздатьНачальныйОбразАвтономногоРабочегоМеста(Настройки,
	...
	Попытка
		...
		РегистрыСведений.ОбщиеНастройкиУзловИнформационныхБаз.ДобавитьЗапись(СтруктураЗаписи);
...
Функция СоздатьНовоеАвтономноеРабочееМесто(Настройки)
	...
	Если ПустаяСтрока(ОбщегоНазначения.ПолучитьЗначениеРеквизита(АвтономнаяРаботаСлужебный.ПриложениеВСервисе(), "Код")) Тогда
		
		ПриложениеВСервисеОбъект = СоздатьПриложениеВСервисе();
		ПриложениеВСервисеОбъект.ДополнительныеСвойства.Вставить("ПолучениеСообщенияОбмена");
	...
	АвтономноеРабочееМестоОбъект.ДополнительныеСвойства.Вставить("ПолучениеСообщенияОбмена");
...
Функция СоздатьСлужебногоПользователяДляСинхронизацииДанных(ИмяПользователя)
	...
	Роли = Новый Массив;
	Роли.Добавить("ВыполнениеОбменовДанными");
...
Функция ВыгрузитьПараметрыВСтрокуXML(ПрефиксАвтономногоРабочегоМеста, Знач ДатаСозданияНачальногоОбраза, АвтономноеРабочееМесто, Знач ИмяПользователя)
	...
	ПараметрыАвтономногоРабочегоМеста = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(АвтономноеРабочееМесто, "Код, Наименование");
	ПараметрыПриложенияВСервисе = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(АвтономнаяРаботаСлужебный.ПриложениеВСервисе(), "Код, Наименование");
	ПараметрыВладельца = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(Пользователи.АвторизованныйПользователь(), "Наименование");
	...
	ЗаписатьXML(ЗаписьXML, ПараметрыВладельца.Наименование, "ИмяВладельца", НазначениеТипаXML.Явное);
