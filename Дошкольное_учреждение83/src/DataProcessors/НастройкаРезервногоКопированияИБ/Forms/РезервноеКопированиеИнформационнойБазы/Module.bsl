...
Процедура ПриПереходеНаАвтоматическийРежимКопирования()
	...
	Если ПроверитьЗаполнение() Тогда
		...
		Если Объект.ВариантПроведенияРезервногоКопирования = 1 Тогда	
			...
			РезервноеКопированиеИБВызовСервера.УстановитьДатуСледующегоАвтоматическогоКопирования(Истина, ПараметрыРезервногоКопированияИБ);
		Иначе
			ОповещатьОРезервномКопированииПриЗавершенииСеанса = Истина;
			РезервноеКопированиеИБВызовСервера.ОстановитьАвтоматическоеРезервноеКопирование(Истина, ПараметрыРезервногоКопированияИБ);
		КонецЕсли;	
