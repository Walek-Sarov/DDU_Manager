...
Процедура ПолучитьОбработчикиКаналовСообщений(Знач Обработчики) Экспорт
	...
	ДобавитьОбработчикКаналаСообщений("ИнформационныйЦентр\Недоступность\Добавление",	ОбработчикКаналовСообщенийИнформационногоЦентра, Обработчики);
	ДобавитьОбработчикКаналаСообщений("ИнформационныйЦентр\Недоступность\Удаление",		ОбработчикКаналовСообщенийИнформационногоЦентра, Обработчики);
	ДобавитьОбработчикКаналаСообщений("ИнформационныйЦентр\Новость\Добавление",			ОбработчикКаналовСообщенийИнформационногоЦентра, Обработчики);
	ДобавитьОбработчикКаналаСообщений("ИнформационныйЦентр\Новость\Удаление",			ОбработчикКаналовСообщенийИнформационногоЦентра, Обработчики);
...
Процедура ОбработатьСообщение(Знач КаналСообщений, Знач ТелоСообщения, Знач Отправитель) Экспорт
	...
	ИначеЕсли КаналСообщений = "ИнформационныйЦентр\Недоступность\Удаление" Тогда 	
		Если ТелоСообщения.Свойство("Идентификатор") Тогда 
			УдалитьДанныеИнфорамционногоЦентра(ТелоСообщения.Идентификатор);
		КонецЕсли;	
...
//
Процедура УдалитьДанныеИнфорамционногоЦентра(Идентификатор)
