...
Процедура УстановитьНовыйПрефиксИВыполнитьОбработкуДанныхСНестандартнымФорматомКода(
	...
	Если ПредыдущийПрефиксИнформационнойБазы = Неопределено Тогда
		...
		ПредыдущийПрефиксИнформационнойБазы = ПрефиксацияОбъектовПереопределяемый.ПрефиксИнформационнойБазы();
	...
	Попытка
		...
		ПрефиксацияОбъектовПереопределяемый.УстановитьПрефиксИнформационнойБазы(НовыйПрефикс);
	...
	Исключение
		...
		ПрефиксацияОбъектовПереопределяемый.УстановитьПрефиксИнформационнойБазы(ПредыдущийПрефиксИнформационнойБазы);
...
Процедура ПроверитьВозможностьУстановкиПрефикса()
	...
	Если Не ПрефиксацияОбъектовПовтИсп.ЕстьФункциональнаяОпцияПрефиксИнформационнойБазы() Тогда
