...
Функция ПрефиксыОрганизаций(Параметры) Экспорт
	
	Возврат ПолучитьФункциональнуюОпцию("ПрефиксыОрганизаций", Параметры);
	
КонецФункции

Функция УстановитьПрефиксИнформационнойБазы(Префикс) Экспорт
