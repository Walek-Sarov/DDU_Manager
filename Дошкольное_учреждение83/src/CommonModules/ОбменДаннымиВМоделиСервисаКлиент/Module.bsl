...
Процедура ПриЗавершенииРаботыСистемы(Предупреждения) Экспорт
	...
	Если ПредлагатьСинхронизироватьДанныеСПриложениемВИнтернетеПриЗавершенииСеанса = Истина
		И АвтономнаяРаботаВызовСервераСлужебный.СинхронизацияССервисомДавноНеВыполнялась() Тогда
		...
		ДействиеПриУстановленномФлажке.Вставить("ПараметрыФормы", АвтономнаяРаботаВызовСервераСлужебный.ПараметрыФормыВыполненияОбменаДанными());
