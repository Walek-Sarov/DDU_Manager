...
Функция ЕстьФункциональнаяОпцияПрефиксыОрганизаций() Экспорт
	...
	Возврат ПрефиксацияОбъектовПереопределяемый.ЕстьФункциональнаяОпцияПрефиксыОрганизаций();
...
Функция ЕстьФункциональнаяОпцияПрефиксИнформационнойБазы() Экспорт
	...
	Возврат ПрефиксацияОбъектовПереопределяемый.ЕстьФункциональнаяОпцияПрефиксИнформационнойБазы();
