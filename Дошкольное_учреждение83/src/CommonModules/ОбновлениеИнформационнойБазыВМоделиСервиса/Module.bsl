...
Процедура ЗапланироватьОбновлениеОбластейДанных(Знач БлокироватьОбласти = Истина, Знач СообщениеБлокировки = "") Экспорт
	...
	Если Результат.Пустой() Тогда // Предварительное чтение, возможно с проявление грязного чтения
		Возврат;
	КонецЕсли;
...
Процедура ОбновлениеОбластейДанных() Экспорт
	...
	// Если выполняется в регламентонм задании, то переходим безусловно в привилегированный режим.
