...
Процедура ПолучитьПисьма(
	...
	Если ИдЗагружать.Количество() <> 0 Тогда
		ОтветственныйЗаОбработкуПисем = ПолучитьОтвественногоЗаОбработкуПисьмаПоУмолчанию(УчетнаяЗапись);
...
//
Функция ПолучитьОтвественногоЗаОбработкуПисьмаПоУмолчанию(УчетнаяЗапись)
