...
#КонецЕсли
	...
	Если Не РезервноеКопированиеИБВызовСервера.ПолучитьДоступностьРолейОповещения() Тогда
		Возврат Неопределено;
	КонецЕсли;
	...
	КоличествоАктивныхАдминистраторов = РезервноеКопированиеИБВызовСервера.ПолучитьКоличествоАктивныхПользователей(Истина);
