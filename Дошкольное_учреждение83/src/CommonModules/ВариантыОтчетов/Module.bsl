...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ВариантыОтчетов.ПереименоватьРольЧтениеВариантовОтчетов";
...
// Переименовывает роль "Чтение вариантов отчетов" на "Использование вариантов отчетов".
//
Процедура ПереименоватьРольЧтениеВариантовОтчетов() Экспорт
	
	ТаблицаПереименований = Новый ТаблицаЗначений;
	ТаблицаПереименований.Колонки.Добавить("СтароеИмяРоли");
	ТаблицаПереименований.Колонки.Добавить("НовоеИмяРоли");
	
	Переименование = ТаблицаПереименований.Добавить();
	Переименование.СтароеИмяРоли = "ЧтениеВариантовОтчетов";
	Переименование.НовоеИмяРоли  = "ИспользованиеВариантовОтчетов";
	
	СтандартныеПодсистемыПереопределяемый.ОбновитьПереименованныеРоли(ТаблицаПереименований);
